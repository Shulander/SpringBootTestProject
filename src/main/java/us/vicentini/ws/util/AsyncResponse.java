 ...
 *
 * <p>The AsyncResponse class seeks to mimic some behaviors defined in the
 * CompletableFuture class provided in JDK version 8. If using JDK 7 or earlier,
 * the AsyncResponse class is a suitable substitute for CompletableFuture.</p>
 *
 * @author Matt Warman
 *
...
public class AsyncResponse<V> implements Future<V> {
     ...
     * @return <p>A boolean that when TRUE indicates the AsyncResponse state was
     * successfully updated. A response of FALSE indicates the AsyncResponse
     * state could not be set correctly.</p>
     */
     ...
     *
     * @param timeout <p>A long number of milliseconds after which the process
     * ceases to wait for state change.</p>
